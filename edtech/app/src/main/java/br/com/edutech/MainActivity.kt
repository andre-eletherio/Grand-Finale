...
import br.com.edutech.screens.MainScreenEd
            ...
            EdutechTheme {
                Surface(
                        ...
                        startDestination = "register")
                    {
                        ...
                        composable(route = "mainEd/{id}"){ navBackStackEntry ->
                            val id = navBackStackEntry.arguments?.getString("id", "")
                            MainScreenEd(navController, id ?: "")
                        }
                        composable(route = "profile/{id}"){ navBackStackEntry ->
                            val id = navBackStackEntry.arguments?.getString("id", "")
                            ProfileScreen(navController, id ?: "")
                        }
                        composable(route = "question/{name}/{id}"){ navBackStackEntry ->
                            val name = navBackStackEntry.arguments?.getString("name", "")
                            val id = navBackStackEntry.arguments?.getString("id", "")
                            QuestionScreen(navController, name ?: "", id ?: "")
                        }
                    }
                }
            }
